...
class Schedule(ndb.Model):
    ...
    year - the year of this schedule, week - The week of the year this
    schedule is for, week_offset - The Offset between the schedules year and
    the true week of the year, image_blob - blob key for the image of this
    schedule.
    """
